        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{route('internship.index')}}">Interships</a></li>
                    <li class="breadcrumb-item active">Add Intership</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
            ...
            <div class="col-md-12">
                ...
                <div class="card card-secondary">
                    <div class="card-header">
                        <h3 class="card-title">Add Intership</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" action="{{route('internship.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
